...
class TestConfigurationManager:
    ...
    async def test_delete_category(self, mocker, reset_singleton):
        @asyncio.coroutine
        def mock_coro(a, b):
            return expected_result
        ...
        ret_val = await c_mgr.delete_category("A")
        assert expected_result == ret_val
    ...
    async def test_delete_category_exception(self, mocker, reset_singleton):
        @asyncio.coroutine
        def mock_coro(a, b):
            return expected_result
